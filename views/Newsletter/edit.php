          ...
          <form class="form-horizontal" role="form" action="update.php" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input type="text" name="name" class="form-control" id="field1" value="<?php echo $email->name;?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-3" for="field2">Email:</label>
                  <div class="col-sm-9">          
                    <input type="text" name="email" class="form-control" id="field2"  value="<?php echo $email->email;?>">
                  </div>
                </div>
                <div class="form-group">        
                  <div class="col-sm-offset-3 col-sm-9">
                    <button type="submit" class="btn btn-default" name="submit">Update Subscribe Email</button>
                  </div>
                </div>
              </form>
