      ...
      <div class="create_wrapper">
          <form class="form-horizontal" role="form" action="store.php" method="post">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <input type="text" name="name" class="form-control" id="field1" placeholder="Enter Book Tittle">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-3" for="field2">Email:</label>
                  <div class="col-sm-9">          
                    <input type="text" name="email" class="form-control" id="field2" placeholder="Enter Creator Name">
                  </div>
                </div>
                <div class="form-group">        
