  ...
  <body>
      <div class="create_wrapper">
          <form class="form-horizontal" role="form" action="update.php" method="post">
                ...
                <div class="form-group">
                <div class="checkbox">
                  <label><input type="checkbox" name="agree" value="Agree" <?php if(trim($checkbox->agree) == "Agree"){echo " checked";} ?>>I accept terms and condition of this website</label>
                </div>
                </div>
                <div class="form-group">        
                  <div class="col-sm-offset-3 col-sm-9">
                    <button type="submit" class="btn btn-default" name="submit">Agree</button>
                  </div>
                </div>
              </form>
