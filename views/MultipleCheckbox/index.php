...
<html lang="en">
  ...
  <body>
		<h1 class="text-center">Multiple Checkbox </h1>
    <div class="wrapper">
	...
	?>
      ...
      <p class="text-center"><a href="../../index.php">Go to Homepage</a> | <a href="create.php"> Multiple Checkbox List</a></p>
