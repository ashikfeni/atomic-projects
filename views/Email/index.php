...
<html lang="en">
  ...
  <body>
	 ...
	 <?php
	   ...
	   ?>
		<tr>
			...
			<td><a href="show.php?id=<?php echo $email->id;?>"><?php echo $email->name;?></a></td>
			<td><?php echo $email->email;?></td>
			<td>
          <a href="show.php?id=<?php echo $email->id;?>">View</a> | 
          <a href="edit.php?id=<?php echo $email->id;?>">Edit</a> | 
	...
	?>
      ...
      <p class="text-center"><a href="../../index.php">Go to Homepage</a> | <a href="create.php">Subscribe Email List</a></p>
