          ...
          <form class="form-horizontal" role="form" action="update.php" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input type="text" name="book_title" class="form-control" id="field1" value="<?php echo $book->title;?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-3" for="field2">Author:</label>
                  <div class="col-sm-9">          
                    <input type="text" name="author" class="form-control" id="field2" value="<?php echo $book->author;?>" >
                  </div>
                </div>
                <div class="form-group">        
