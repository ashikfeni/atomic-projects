...
<html lang="en">
  ...
  <body>
	 ...
	 <?php
	   ...
	   ?>
		<tr>
			...
			<td><a href="show.php?id=<?php echo $summary->id;?>"><?php echo $summary->name;?></a></td>
			<td><?php echo $summary->summary;?></td>
			<td>
          <a href="show.php?id=<?php echo $summary->id;?>">View</a> | 
	...
	?>
      ...
      <p class="text-center"><a href="../../index.php">Go to Homepage</a> | <a href="create.php">Add Birthday</a></p>
